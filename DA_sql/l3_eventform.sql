...
CREATE TABLE `eventform` (
  `event_form_id` int NOT NULL AUTO_INCREMENT,
  ...
  `note` text,
  PRIMARY KEY (`event_form_id`),
  KEY `employee_id` (`employee_id`),
  CONSTRAINT `eventform_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`)
...
-- Dump completed on 2024-09-14 17:32:36
