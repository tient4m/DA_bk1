...
export class OrderAdminComponent implements OnInit {
  ...
  exportPDF(invoiceId: number) {
    this.orderService.exportInvoiceToPDF(invoiceId).subscribe(
      (response: any) => {
        debugger
        // Sử dụng file-saver để lưu file PDF với tên tùy chỉnh
        const fileName = `invoice_order_${invoiceId}.pdf`;
